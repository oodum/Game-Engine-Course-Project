...
public partial class @PlayerInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerInputActions()
    {
        UnityEngine.Debug.Assert(!m_Fight.enabled, "This will cause a leak and performance issues, PlayerInputActions.Fight.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Passive.enabled, "This will cause a leak and performance issues, PlayerInputActions.Passive.Disable() has not been called.");
    }
